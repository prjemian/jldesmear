...
.. see lake.smear.Plengt() for an example of formatted math

.. needs graphviz
.. .. inheritance-diagram:: lake.lake lake.smear lake.StatsReg lake.textplots
...
We'll use UNIX shell redirection to get everything in a text file::
	...
	cd src/lake/data
	python ../lake.py < test1.inp > test1.out
