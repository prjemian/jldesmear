...
def GetInf(info):
    ...
    :param info: dictionary of input terms by keyword 
    :type info: dict
    '''
...
def plot_results (q, E, C):
    ...
    :type q: [float]
    :param E: experimental (smeared) data
    :type E: [float]
    :param C: corrected (desmeared) data
    :type C: [float]
    '''
    n = len(q)
...
def print_results (q, E, dE, C, dC):
    ...
    :param E: experimental (smeared) data
    :type E: [float]
    :param dE: estimated uncertainties of *E*
    :type dE: [float]
    :param C: corrected (desmeared) data
    :type C: [float]
    :param dC: estimated uncertainties of *C*
    :type dC: [float]
    '''
    print "%s\t%s\t%s\t%s\t%s" % ( 
            "Qsas",
...
def traditional_command_line_interface ():
    ...
    info = {                # set the defaults
        "infile": "/mnt/sdcard/sl4a/scripts/data/test.smr", 
        "outfile": "/mnt/sdcard/sl4a/scripts/test.dsm",
